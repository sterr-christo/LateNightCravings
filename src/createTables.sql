CREATE TABLE Restaurant(RestaurantID INT PRIMARY KEY, Name TEXT, Zip INT, State TEXT, City TEXT, Street TEXT, Latitude INT, Longitude INT,  GenreID INT REFERENCES Genre(GenreID), Delivery NUMERIC, Phone TEXT, Website TEXT, Email TEXT, ClosingTime INT);
...
CREATE TABLE Genre(GenreID INT PRIMARY KEY, Name TEXT, Description TEXT);
